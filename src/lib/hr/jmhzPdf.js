...
export const JMHZ_FIELD_MAPS = {
  ...
  // Realny vyplneny exemplar dodany v hr-podklady/ (lokalny, necommitnuty) ma
  // in verziu ("20.3.2026 C") - jej original PRAZDNY formular nebol dodany,
  // takze rovnaky poziciovy audit ako vyssie pre nu vykonat NEMOZNO. Necham
  // zamerne ako prazdnu kostru (ziadne "field name -> key" hadanie naslepo) -
  // extractJmhzFields nizsie preto pre tuto verziu vzdy vrati NEZNAMA_VERZIA
  // a zastavi import na manualnu kontrolu, presne podla MASTER_PROMPT.
  "20.3.2026 C": {
    versionLabel: "20.3.2026 C",
    sourceNote: "NEOVERENE - original prazdny formular tejto verzie nebol dodany do repozitara ani inak sprístupneny. " +
      "Zamerne bez mapovania polí (viz zaverecna sprava).",
    fields: {},
  },
};
